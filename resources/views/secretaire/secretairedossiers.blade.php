        ...
        ***********************************-->
        <div class="content-body">
			...
			<div class="container-fluid">
				...
				<div class="form-head d-flex mb-3 mb-md-4 align-items-start">
					<div class="me-auto d-none d-lg-block">
						<a href="javascript:void(0);"  data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary btn-rounded">+ Ajouter un dossier</a>
					</div>
                                        ...
                                        @foreach($dossiers as $dossier)
											...
											<tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="me-3">
													<a href="{{ route('secretaireVisites', $dossier->id) }}"   ><i class="fa fa-file-text fs-18 text-success"  aria-hidden="true">
                                                    </i></a>
													</span>	
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <form method="post"  action="{{ route('secretaireADDdossierPost') }}" enctype="multipart/form-data" >
                @csrf
				<div class="modal-content"> 
				  ...
				  <div class="modal-body">
					...
					<div class="col-xl-6">
                            ...
                            <input type="text" class="form-control" id="nom"  required name="nom" placeholder="nom">
						</div>
                        <div class="col-xl-6">
                            <label class="form-label">Prénom Patient</label>
                            <input type="text" class="form-control" id="prenom"  required name="prenom" placeholder="prenom">
						</div>
                        <div class="col-xl-6">
                            <label class="form-label">Numero de telephone</label>
                            <input type="integer" class="form-control" id="num_telephone"  required name="num_telephone" >
						</div>
                        <div class="col-xl-6">
                            <label class="form-label">Adresse</label>
                            <input type="text" class="form-control" id="adresse"  required name="adresse" placeholder="adresse">
						</div>

                        <div class="col-xl-6">
                    		<div class="form-group">
                                <label for="parent_id" class="col-form-label">Nom Parent</label>
						...
						<div class="col-xl-6">
                    		<div class="form-group">
                                <label for="medecin_id" class="col-form-label">Nom Medecin</label>
                                    <select name="medecin_id" class="form-control" required>
                                        <option>Sélécetionner un medecin</option>
                        ...
                        <div class="col-xl-6">
                            <label class="form-label">Photo patient</label>
                            <input type="file" class="form-control" id="photo" name="photo" >
						</div>
                        <div class="col-xl-6">
                            <label class="form-label">Date de naissance</label>
                            <input type="date" class="form-control" id="date_naissance"  required name="date_naissance">
						</div>
						<div class="col-xl-6">
                            <label class="form-label">Numero de dossier</label>
                            <input type="text" class="form-control" id="num_dossier"  required name="num_dossier" placeholder="Entrer Numero de dossier">
						</div>
                        <div  class="col-xl-6" >
                        ...
                        <div class="col-xl-6">
                            ...
                            <input type="text" class="form-control" id="num_facultatif"  required name="num_facultatif" placeholder="Entrer Numero de facultatif">
						</div>
                        
                        <div class="col-xl-6">
                            <label for="couverture_sociale">Type de couverture</label>
                            <select id="couverture_sociale" name="couverture_sociale">
            ...
            <div class="modal-dialog modal-lg">
                <form id="editDossierForm" method="post" action="{{ route('secretaireEDITdossierPost') }}" enctype="multipart/form-data">
                @csrf
            ...
            <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel3" aria-hidden="true">
			  <div class="modal-dialog modal-lg" role="document">
              <form method="post"  id="deleteDossierForm" action="{{route('secretaireDELETEdossierPost')}}" >
                @csrf
                <div class="modal-content"> 
				  <div class="modal-header">
					<h5 class="modal-title" id="exampleModal3Label">Supprimer un dossier</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
					</button>
				  </div>
				  <div class="modal-body">
				  <input type="hidden" name="id" value=""  >
					...
					<div class="row">
						<div class="col-xl-12">
                        <h4 class="text-danger text-center">Vous êtes sur de vouloir supprimer cet dossier:  </h4> 
						<input type="text" class="form-control" disabled id="num_dossier" value="{{ $dossier->num_dossier ?? '' }}" name="num_dossier" required>                             
...
<script>
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', function () {
            const form = document.getElementById('deleteDossierForm');
            const dataAttributes = {
                id: this.getAttribute('data-id'),
                num_dossier: this.getAttribute('data-num-dossier'),
